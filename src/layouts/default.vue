<template>
    <!-- side bar -->
    <div class="max-h-screen bg-gray-100 flex w-auto">
        <div class="sidebar min-h-screen w-56 border-r hover:shadow-lg">
                    ...
                    <ul class="mt-6 space-y-2 tracking-wide">
                        ...
                        <!-- <li class="min-w-max">
                            <router-link :to="{ name: 'NewProduct', params: {} }"
                                ...
                                <span class="group-hover:text-gray-700">Add New Product</span>
                            </router-link>
                        </li> -->
                    </ul>
                </div>
